#!/usr/bin/env python3
"""
ollama-open (unsandboxed variant of ollama-fs)
...
Sibling: ollama-fsb.py (sandboxed: confines the agent to a single directory).
"""
...
parser = argparse.ArgumentParser(
    ...
    epilog=(
        'Examples:\n'
        '  ollama-open.py -m gemma4 ~/projects/foo\n'
        '  ollama-open.py -m gemma4 -a openclaw /\n'
        '  ollama-open.py -m gemma4 /home/james --safe\n'
        '  ollama-open.py -m gemma4 . --safe --debug\n'
        '  ollama-open.py -a openclaw ~                # agent only\n'
    )
)
