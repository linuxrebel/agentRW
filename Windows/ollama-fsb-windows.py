#!/usr/bin/env python3
# ollama-fsb-windows.py - Windows-compatible version of ollama-fsb (sandboxed)
#
# Sibling: ollama-open-windows.py (unsandboxed variant with shell-exec).
#
# Differences from ollama-fsb.py (Linux/Mac):
...
parser = argparse.ArgumentParser(
    prog='ollama-fsb (Windows)',
    description='A terminal CLI agent that gives a local Ollama model sandboxed file-system access.',
    formatter_class=argparse.RawTextHelpFormatter,
    epilog=(
        'Examples:\n'
        '  ollama-fsb-windows.py -m gemma4 .\\my_project\n'
        '  ollama-fsb-windows.py -m gemma4 -a openclaw .\\my_project\n'
        '  ollama-fsb-windows.py -m gemma4 .\\my_project --safe\n'
        '  ollama-fsb-windows.py -m gemma4 .\\my_project --safe --debug\n'
        '  ollama-fsb-windows.py -a openclaw .\\my_project\n'
    )
)
